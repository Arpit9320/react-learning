...
const App = () => {
  ...
  const jobOpenings = [
    ...
    {
      brandLogo: "https://imgs.search.brave.com/HwC9NgF0FaeZvZMCjLEDMeM0E5oWYJ3N8iIUyL6I_gE/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/cG5nYWxsLmNvbS93/cC1jb250ZW50L3Vw/bG9hZHMvMTMvR29v/Z2xlLUxvZ28tUE5H/LUltYWdlLnBuZw",
      companyName: "Google",
  ...
  return (
      <div className='parent'>
        {jobOpenings.map(function (elem, idx) {
          return <div key={idx}>
            <Cards company={elem.companyName} datePosted={elem.datePosted} post={elem.post} tag1={elem.tag1} brandLogo={elem.brandLogo} pay={elem.pay} tag2={elem.tag2} location= {elem.location}/>
          </div>
        })}
      </div>
    )
